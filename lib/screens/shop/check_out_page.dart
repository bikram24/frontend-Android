...
import 'package:ecommerce_int2/screens/notification.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Product> products = [
    Product('assets/silhoutte-removebg-preview.png', 'Silhoutte Golden Guitar',
        'description', 45.3),
    Product('assets/stratocasterBlack-removebg-preview.png',
        'Black Stratocaster Guitar', 'description', 22.3),
    Product('assets/whiteguitar-removebg-preview.png', 'White Beauty Guitar',
        'description', 58.3)
  ];
